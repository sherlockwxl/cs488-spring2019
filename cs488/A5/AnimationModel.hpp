...
// for character 1
    ...
    std::vector<glm::mat4> ori_joint_trans_c1;
// for character 2
    ...
    std::vector<glm::mat4> ori_joint_trans_c2;


    AnimationModel();
    void rotateJointHelper(GLfloat anglex, GLfloat angley, GLfloat anglez,SceneNode & root, int type, int order, int id, int characterId);

...
void A0::guiLogic()
{
	...
	ImGui::Begin("Shape Properties", &showDebugWindow, ImVec2(100,100), opacity,
		...
		// reset the colour, scale, rotation, position
		...
		ImGui::SliderFloat("Rotation Angle", &m_shape_rotation, 0.0f, PI * 2);
